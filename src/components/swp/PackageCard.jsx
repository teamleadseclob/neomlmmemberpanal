...
/**
 * @param {Object} props
 * @param {string} props.tierLabel    – "TIER 01", "ELITE TIER 06", etc.
 * @param {string} props.title        – "$100 Package"
 * @param {number} props.price
 * @param {number} props.maxLimit
 * @param {string} props.leverage     – "10.0x"
 * @param {string} props.icon         – key from TIER_ICONS
 * @param {'repurchase'|'upgrade'|'select'} props.btnType
      ...
      {badge && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2">
          <span className="text-[9px] font-bold uppercase tracking-wider px-3 py-1 rounded-full
                           bg-gradient-to-r from-[#7F25FB] to-[#CB3CFF] text-white whitespace-nowrap">
            {badge}
          </span>
        </div>
      )}
