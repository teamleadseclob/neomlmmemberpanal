...
const TIER_ICONS = {
  ...
  rocket: (<svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="url(#rocketGradCard)" strokeWidth={1.5}>
          <defs>
            <linearGradient id="rocketGradCard" x1="0%" y1="0%" x2="100%" y2="100%" gradientTransform="rotate(128.49)">
